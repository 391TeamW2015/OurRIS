			...
			if (userName.equals("") && passwd.equals("")){
		        ...
		        if(passwd.equals(truepwd)){
	        		...
	        		if (userClass.equals("a")){
	    		    	...
	    		    	out.println("<script language=javascript type=text/javascript>");
	    		    	out.println("setTimeout("+"\"javascript:location.href='../view/administrator.html'\""+", 1000);");
	    		    	out.println("</script>");
	        		}
	        			...
	        			out.println("</CENTER></form>");
	    		    	out.println("<script language=javascript type=text/javascript>");
	    		    	out.println("setTimeout("+"\"javascript:location.href='../view/doctor.html'\""+", 1000);");
	    		    	out.println("</script>");
	        		}
	        			...
	        			out.println("</CENTER></form>");
	    		    	out.println("<script language=javascript type=text/javascript>");
	    		    	out.println("setTimeout("+"\"javascript:location.href='../view/patient.html'\""+", 1000);");
	    		    	out.println("</script>");
	        		}
		        }
